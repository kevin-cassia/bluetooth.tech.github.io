...
// Version 2 (fixes version 1 in sn parse errors and sn format issues)
...
// Version 3 (fixes return null issue)
...
This is a simple js library with two functions.


## parseMsg(data) 
> 
**Parameter：**
	data: Bluetooth raw data
**Return：**
	Message Object  ex. Message {**sn**: "B033/0042430", **temperature**: 18.8425, **battery**: 20}
	This object contains three properties.
	* sn: 			Serial number of the temperature patch.
	* temperatur: 	Patch temperature data
	* battery:		Current battery information.
...
**Parameter：**
	data: Bluetooth raw data
**Return：**
	boolean: Is it the data of the VV200 temperature sticker?

 */



/* Parsed according to version one.  
